...
const Exam = () => {
	return(
		<div> 
			...
			<TestBox title="Understanding Self Through Observed Perceptions (USTOP)" link="/test/ustop" desc="Anxiety test designed for evaluating anxiety levels of an individual."/>
