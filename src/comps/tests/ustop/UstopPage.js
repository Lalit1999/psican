...
import test from '../../../images/test2.jpeg' ;
...
const UstopPage = () => {
	...
	const itProps = {
		...
		p1: 'चिंता हमारे व्यवहार, स्वास्थ्य, मनोदशा और कार्य क्षमता पर अत्यधिक प्रभाव डालती है । अपनी चिंता को स्वयँ जाने व उसके निदान को समझे ।',
		p2: 'Anxiety has deep impace on our Behaviour, Health, Mental Status and Efficiency. Know your Anxiety level yourself and understand how you can help yourself.',
	}
